...
library PbEntity {
    ...
    function TokenTypes(uint256[] memory arr) internal pure returns (TokenType[] memory t) {
        ...
        for (uint256 i = 0; i < t.length; i++) { t[i] = TokenType(arr[i]); }
    }
    ...
    function TransferFunctionTypes(uint256[] memory arr) internal pure returns (TransferFunctionType[] memory t) {
        ...
        for (uint256 i = 0; i < t.length; i++) { t[i] = TransferFunctionType(arr[i]); }
    }
    ...
    function ConditionTypes(uint256[] memory arr) internal pure returns (ConditionType[] memory t) {
        ...
        for (uint256 i = 0; i < t.length; i++) { t[i] = ConditionType(arr[i]); }
    }
