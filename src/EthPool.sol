...
contract EthPool is IEthPool {
    ...
    function deposit(address _receiver) public payable {
        ...
        balances[_receiver] = balances[_receiver] + msg.value;
    ...
    function withdraw(uint256 _value) public {
        _transfer(msg.sender, payable(msg.sender), _value);
    }
     ...
     */
    function transferFrom(address _from, address payable _to, uint256 _value) public returns (bool) {
